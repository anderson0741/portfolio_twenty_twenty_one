...
class Groups_Taxonomies {
	...
	function create_taxonomies() {
		register_post_type( 'um_groups', array(
			...
			'taxonomies'            => array( 'um_group_categories', 'um_group_tags' ),
			'rewrite'               => array( 'slug' => UM()->options()->get( 'groups_slug' ) ),
		...
		$args = array(
			...
			'query_var'             => false,
			'rewrite'               => array(
				'slug'  => UM()->options()->get( 'group_category_slug' )
			),
		);
		...
		register_taxonomy( 'um_group_tags', 'um_groups', array(
			...
			'query_var'             => true,
			'rewrite'               => array(
				'slug' => UM()->options()->get( 'group_tag_slug' ),
			),
		) );
	}
