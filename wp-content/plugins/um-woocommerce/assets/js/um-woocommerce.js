jQuery(document).ready(function (e) {
	...
	/* Orders */
	jQuery(document.body).on('click', '.um-woo-orders .um-woo-view-order, .um-woo-orders a.button.view', um_wc_display_order);
...
function um_wc_refresh_address(country, type, field) {
	...
	if ( !form_id && jQuery( field ).closest( 'form' ).length ) {
