 ...
 * Instantiate plugin.
 */
global $cxec_supreme_theme;
$cxec_supreme_theme = ec_supreme_theme();
...
class WC_Email_Theme_Supreme {
	...
	*/
	public function init(){
		...
		add_action( 'init', array( $this, 'remove_additional_info' ) );
	}
 ...
 */
function ec_supreme_theme() {
	return WC_Email_Theme_Supreme::get_instance();
}
